...
/**
* Vastaukset demo2t4:
 * a) BankTransfer: luokassa oli ongelmana se, että säikeet pääsivät lukitsemaan pankkitilejä eri aikaan joka johti
 *    kehälukkiumaan. Deadlock-tilanne syntyi koska jos eräs säie lukitsee ensin tilin A ja toinen säie samaan aikaan
 *    tilin B. Tämä johtaa tilanteeseen, missä ensimmäinen säie odottaa tilin B vapautumista ja toinen säie odottaa
 *    tilin A vapautumista. Loppujenlopuksi kumpikaan säie ei pääse eteenpäin.
 *
 * b) Korjasin hyödyntämällä concurrent-luokan tarjoamia ReentrantLock-lukkoja. Niiden avulla deadlock-tilanne
 *    voidaan välttää koska lukkoja voidaan uudelleenlukita.
 *
 */